---
title: "Misc / Farewell Gift - Writeup DDC 2025"
...
Gõ `python run.py > summary.txt` thì nó sẽ ra một cái list đúng dài. Nhưng nếu ai có học qua 1 lớp AI trên trường hoặc tự học của Andrew Ng thì cũng nhận ra đây là EfficientNetV2. Sao mình biết? Do cách đặt tên:
...
<img src="image.png" alt="image.png" style="width: 90%; height: auto;" />
